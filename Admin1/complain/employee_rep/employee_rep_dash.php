    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12 mx-auto">
                ...
                <div class='col-12'><a class='btn btn-secondary' href='../../Admin1.php'>عودة</a></div>
                </h1>
            </div>
            <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12  mx-auto">
                <h1 class="text-center">
        ...
        <div class="p-5 mt-5"
            ...
            <div class="h3 text-decoration-none">
                <a href="./employee_rep_general.php" class="text-decoration-none">
                    قائمة عامة بالموظفين
                     </a>
            </div>


            <div class="h3 text-decoration-none mt-5">
                <a href="./employee_rep_atten.php" class="text-decoration-none">
                كشف الحضور  </a>
            </div>
