...
$sql = "SELECT * from worker order by w_access desc";
$params = array(1, "some data");

$stmt = sqlsrv_query( $conn, $sql, $params);

$date = $row['w_insert_date'];
...
echo '<div><h2 class="mt-5 text-right mb-5">قائمة الموظفين الحاليين</h2></div> ' ;
echo '</div>' ;

echo '<table border="1" class="table table-striped text-center mx-auto">' ;
echo '<tr>' ;
echo '<th class="text-dange" style="color:#a17e22;">Name</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">Address</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">Age</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">Access in System</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">Phone</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">E-mail</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">Salary</th>' ;
echo '<th class="text-dange" style="color:#a17e22;">Date of Join</th>' ;
echo '<th>Account Password</th>' ;
echo '</tr>' ;
echo '<tr>' ;
while ( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)) {
    echo "<th> $row[w_name] </th>" ;
    echo "<th>  $row[w_address] </th>" ;
    echo "<th>  $row[w_age] </th>" ;
    echo "<th>  $row[w_access] </th>" ;
    echo "<th>  $row[w_phone] </th>" ;
    echo "<th>  $row[w_mail] </th>" ;
    echo "<th>  $row[w_salary] </th>" ;
    echo "<th>  $formatted_date </th>" ;
    echo "<th class='text-dange' style='color:#630909;'>  $row[w_pass] </th>" ;
