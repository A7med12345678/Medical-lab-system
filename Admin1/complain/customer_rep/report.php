...
if (isset($_POST['c_id'])) {
   ...
   echo '<tr>' ;
   echo '<th class="text-dange" style="color:#a17e22;">Test Code</th>' ;
   echo '<th class="text-dange" style="color:#a17e22;">Test Content</th>' ;
   echo '<th class="text-dange" style="color:#a17e22;">Test Price</th>' ;
   echo '<th class="text-dange" style="color:#a17e22;">Test Result</th>' ;
   echo '<th class="text-dange" style="color:#a17e22;">Receptionist</th>' ;
   echo '<th class="text-dange" style="color:#a17e22;">Test Date</th>' ;
   echo '</tr>' ;
   echo '<tr>' ;
