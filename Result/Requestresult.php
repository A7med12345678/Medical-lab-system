...
if (isset($_POST['t_ran_code'])) {
    ...
    $sql = "SELECT * FROM test WHERE t_ran_code = '$t_ran_code'";
 ...
 //  echo $patient_result;
    ...
    if ($row) {
        echo "<div class='row mt-5 mb-5 mx-auto text-center'> <div class='col-12'><a class='btn btn-secondary' href='./result.php'>استخراج النتيجة</a></div></div>";
    }else{
