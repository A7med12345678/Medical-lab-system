        ...
        if ($res = "exist") {
            ...
            */
            ...
            if (sqlsrv_rows_affected($stmt2)) {
                ...
                echo "<div class='row'><div class='p-5 mt-5 col-9 mx-auto text-center h3 text-danger' style='background:rgb(221, 219, 219)'>الرجاء إدخال البيانات بصورة صحيحة</div></div>";
