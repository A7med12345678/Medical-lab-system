...
$name = $_SESSION['w_id'];
$sql = "SELECT w_name from worker where w_id = '$name' ";
$params = array(1, "some data");
$stmt = sqlsrv_query( $conn, $sql, $params);
$row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC);
$worker = implode('',$row);
// export login name to another pages : 
$_SESSION['w_name'] = $worker;
// if use foreach to fetch login name
$finalname = [];
array_push($finalname, $row);
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="p-5 mt-5"
            ...
            <div class="h3 text-decoration-none mt-5">
            ...
            <div class="h3 text-decoration-none mt-5">
                <a href="../Result/Requestresult.php" class="text-decoration-none">
                    استخراج نتيجة تحاليل</a>
            </div>
